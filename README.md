# Apache2 + PHP 7.1 + MariaDB 10.1 Client Docker Container for AARCH64, ARMv7l, X86 and X64

For hosting PHP powered websites.

## Required Docker Image
The Docker Image **ws-apache-php71-mariadb101-\<ARCH\>** will automaticly be downloaded from the Docker Hub.  
The source for the image can be found here [https://github.com/tsitle/dockerimage-ws-apache\_php71_mariadb101](https://github.com/tsitle/dockerimage-ws-apache_php71_mariadb101).
